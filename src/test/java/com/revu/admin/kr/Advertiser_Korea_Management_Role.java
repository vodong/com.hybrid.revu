...
//		driver = getBrowserDriver(browserName, environment.appUrl());
	...
	public void TC_02_Login_To_DashBoard_Page(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Admin Page - Step 01: Enter Email'" + GlobalConstants_KR.EMAIL_MANAGER_ROLE + "'");
		adminHomePage.enterToEmailTextbox(GlobalConstants_KR.EMAIL_MANAGER_ROLE);
	...
	public void TC_03_Check_Translate_To_Korea_Brand_Management_Page(Method method) {
		...
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("브랜드명", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 05: Verify Field label is Korea languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderFieldDropDownListDisplayed("분야", GlobalConstants_KR.PLACE_HOLDER_FIELD_DROPDOWN_LIST_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 06: Verify Representative label is Korea languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("담당자명", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_KR));
		...
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("이메일", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 09: Verify Phone label is Korea languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("휴대전화", GlobalConstants_KR.PLACE_HOLDER_PHONE_TEXTBOX_KR));
	...
	public void TC_04_Check_Translate_To_English_Brand_Management_Page(Method method) {
		...
		adminBrandManagementPage.openSelectLanguageList(driver, GlobalConstants_KR.ENGLISH_LANGUAGE);
		...
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("Brand", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 4: Verify Field label is English languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderFieldDropDownListDisplayed("Field", GlobalConstants_KR.PLACE_HOLDER_FIELD_DROPDOWN_LIST_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 5: Verify Representative label is English languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("Representative", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 6: Verify Partner label is English languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("Partner", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 7: Verify Email label is English languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("Email", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Brand Management Page - Step 8: Verify Phone label is English languages");
		assertTrue(adminBrandManagementPage.isPlaceHolderDisplayed("Phone", GlobalConstants_KR.PLACE_HOLDER_PHONE_TEXTBOX_EN));
		...
		adminBrandManagementPage.openSelectLanguageList(driver, GlobalConstants_KR.KOREA_LANGUAGE);
	}
	...
	public void TC_05_Check_Translate_To_Korea_Create_Brand_Page(Method method) {
		...
		adminBrandManagementPage.openCreateANewBrand(GlobalConstants_KR.CREATE_A_NEW_BRAND_BUTTON);
		...
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("브랜드명", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 07: Verify Partner area translate to Korea");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("파트너", GlobalConstants_KR.PLACE_HOLDER_PARTNER_DROPDOWN_LIST_KR));
		...
		assertTrue(adminCreateNewBrandPage.isButtonNameDisplayed(GlobalConstants_KR.USE_BUTTON_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 10: Verify Nonuse button translate to Korea");
		assertTrue(adminCreateNewBrandPage.isButtonNameDisplayed(GlobalConstants_KR.NON_USE_BUTTON_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 11: Verify Field area translate to Korea");
		assertTrue(
				adminCreateNewBrandPage.isPlaceHolderByDropDownListNameDisplayed("분야", GlobalConstants_KR.PLACE_HOLDER_FIELD_DROPDOWN_LIST_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 12: Verify Save button translate to Korea");
		assertTrue(adminCreateNewBrandPage.isSaveButtonDisplayed(GlobalConstants_KR.SAVE_BUTTON_KR));

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 13: Verify Save button is disabled");
		assertFalse(adminCreateNewBrandPage.isSaveButtonDisabled(GlobalConstants_KR.SAVE_BUTTON_KR));
		...
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByDropDownListNameDisplayed("분야", GlobalConstants_KR.FIELD_DROPDOWN_LIST));

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 15: Verify Save button is disabled");
		assertTrue(adminCreateNewBrandPage.isSaveButtonDisabled(GlobalConstants_KR.SAVE_BUTTON_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 16: Verify Account Information After Clicking On 'Use' Button");
		adminCreateNewBrandPage.clickOnButtonByName(GlobalConstants_KR.USE_BUTTON_KR);

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 17: Verify Email area translate to Korea");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("이메일", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_KR));
		...
		assertEquals(adminCreateNewBrandPage.getTextResetPasswordButton(), GlobalConstants_KR.PASSWORD_SETTING_KR);

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 20: Verify Representative area translate to Korea");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("담당자명", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_KR));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 21: Verify Phone area translate to Korea");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("휴대전화", GlobalConstants_KR.PLACE_HOLDER_PHONE_TEXTBOX_KR));
...
//		ExtentTestManager.getTest().log(Status.INFO,
//				"Create Brand Page - Step 25: Verify Password Setting button translate to Korea");
//		assertEquals(adminCreateNewBrandPage.getTextResetPasswordButton(), GlobalConstants_KR.PASSWORD_SETTING_KR);

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 25: Click on Password Setting Button");
		adminCreateNewBrandPage.clickToPasswordSettingButton(GlobalConstants_KR.PASSWORD_SETTING_KR);
		
		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 26: Verify Password Setting will be changed to Cancel Setting");
		assertEquals(adminCreateNewBrandPage.getTextResetPasswordButton(), GlobalConstants_KR.CANCEL_SETTING_KR);

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 27: Enter Password '" + GlobalConstants_KR.PASSWORD + "'");
		adminCreateNewBrandPage.enterToPasswordTextBox(GlobalConstants_KR.PASSWORD);
		
		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 28: Enter Confirm Password is not match '" + GlobalConstants_KR.INCORRECT_PASSWORD + "'");
		adminCreateNewBrandPage.enterToConfirmPasswordTextBox(GlobalConstants_KR.INCORRECT_PASSWORD);
	...
	public void TC_06_Check_Translate_To_English_Create_Brand_Page(Method method) {
		...
		adminCreateNewBrandPage.openSelectLanguageList(driver, GlobalConstants_KR.ENGLISH_LANGUAGE);
		...
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("Brand",GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 08: Verify Partner area translate to English");
		assertTrue(
				adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("Partner", GlobalConstants_KR.PLACE_HOLDER_PARTNER_DROPDOWN_LIST_EN));
		...
		assertTrue(adminCreateNewBrandPage.isButtonNameDisplayed(GlobalConstants_KR.USE_BUTTON_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 11: Verify Nonuse button translate to English");
		assertTrue(adminCreateNewBrandPage.isButtonNameDisplayed(GlobalConstants_KR.NON_USE_BUTTON_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 12: Verify Field area translate to English");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByDropDownListNameDisplayed("Field",GlobalConstants_KR.PLACE_HOLDER_FIELD_DROPDOWN_LIST_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 13: Verify Save button translate to English");
		assertTrue(adminCreateNewBrandPage.isSaveButtonDisplayed(GlobalConstants_KR.SAVE_BUTTON_EN));

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 14: Verify Save button is disabled");
		assertFalse(adminCreateNewBrandPage.isSaveButtonDisabled(GlobalConstants_KR.SAVE_BUTTON_EN));

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 15: Verify Field after selecting value");
		adminCreateNewBrandPage.selectField(GlobalConstants_KR.FIELD_DROPDOWN_LIST);
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByDropDownListNameDisplayed("Field", GlobalConstants_KR.FIELD_DROPDOWN_LIST));

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 16: Verify Save button is disabled");
		assertTrue(adminCreateNewBrandPage.isSaveButtonDisabled(GlobalConstants_KR.SAVE_BUTTON_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 17: Verify Account Information After Clicking On 'Use' Button");
		adminCreateNewBrandPage.clickOnButtonByName(GlobalConstants_KR.USE_BUTTON_EN);

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 18: Verify Email area translate to English");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("Email", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_EN));
		...
		assertEquals(adminCreateNewBrandPage.getTextResetPasswordButton(), GlobalConstants_KR.PASSWORD_SETTING_EN);

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 21: Verify Representative area translate to English");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("Representative", GlobalConstants_KR.PLACE_HOLDER_TEXTBOX_EN));

		ExtentTestManager.getTest().log(Status.INFO,
				"Create Brand Page - Step 22: Verify Phone area translate to English");
		assertTrue(adminCreateNewBrandPage.isPlaceHolderByLabelNameDisplayed("Phone", GlobalConstants_KR.PLACE_HOLDER_PHONE_TEXTBOX_EN));
		...
		adminCreateNewBrandPage.clickToPasswordSettingButton(GlobalConstants_KR.PASSWORD_SETTING_EN);
		...
		assertEquals(adminCreateNewBrandPage.getTextResetPasswordButton(), GlobalConstants_KR.CANCEL_SETTING_EN);

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 28: Enter Password '" + GlobalConstants_KR.PASSWORD + "'");
		adminCreateNewBrandPage.enterToPasswordTextBox(GlobalConstants_KR.PASSWORD);
		
		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 29: Enter Confirm Password is not match '" + GlobalConstants_KR.INCORRECT_PASSWORD + "'");
		adminCreateNewBrandPage.enterToConfirmPasswordTextBox(GlobalConstants_KR.INCORRECT_PASSWORD);
	...
	public void TC_07_Create_Brand_Non_Use_Option(Method method) {
		...
		adminCreateNewBrandPage.openSelectLanguageList(driver, GlobalConstants_KR.KOREA_LANGUAGE);
		...
		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 07: Input Partner Name '" + GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD + "'");
		adminCreateNewBrandPage.enterToPartNameTextBox(GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD);

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 08: Select Partner Name '" + GlobalConstants_KR.PARTNER_NAME_AND_EMAIL_SEARCH_FIELD + "'");
		adminCreateNewBrandPage.selectPartnerByName(GlobalConstants_KR.PARTNER_NAME_AND_EMAIL_SEARCH_FIELD);
		...
		assertTrue(adminBrandManagementPage.isTextCreatedBrandAtRowDisplayed("파트너명", "1", GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD));
		assertTrue(adminBrandManagementPage.isTextCreatedBrandAtRowDisplayed("브랜드명", "1", brandName));
		assertTrue(adminBrandManagementPage.isTextCreatedBrandAtRowDisplayed("분야", "1", GlobalConstants_KR.FIELD_DROPDOWN_LIST));
	...
	public void TC_08_Delete_Brand_Advertiser_Do_Not_Have_CamPaign(Method method) {
		...
		adminBrandManagementPage.clickToDeleteButtonByRownNumber("1", GlobalConstants_KR.DELETE_BUTTON);
		...
		adminBrandManagementPage.openByNameLink(driver, GlobalConstants_KR.BRAND_MANAGEMENT_LINK);
	...
	public void TC_09_Create_Brand_Use_Option(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 06: Input Partner Name '" + GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD + "'");
		adminCreateNewBrandPage.enterToPartNameTextBox(GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD);

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 07: Select Partner Name '" + GlobalConstants_KR.PARTNER_NAME_AND_EMAIL_SEARCH_FIELD + "'");
		adminCreateNewBrandPage.selectPartnerByName(GlobalConstants_KR.PARTNER_NAME_AND_EMAIL_SEARCH_FIELD);
		...
		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 11: Input Password '" + GlobalConstants_KR.PASSWORD + "'");
		adminCreateNewBrandPage.enterToPasswordTextBox(GlobalConstants_KR.PASSWORD);
		
		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 12: Input Confirm Password '" + GlobalConstants_KR.PASSWORD + "'");
		adminCreateNewBrandPage.enterToConfirmPasswordTextBox(GlobalConstants_KR.PASSWORD);
		...
		adminBrandManagementPage.isTextCreatedBrandAtRowDisplayed("파트너명", "1", GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD);
		adminBrandManagementPage.isTextCreatedBrandAtRowDisplayed("브랜드명", "1", brandName);
		adminBrandManagementPage.isTextCreatedBrandAtRowDisplayed("분야", "1", GlobalConstants_KR.FIELD_DROPDOWN_LIST);
	...
	public void TC_10_Delete_Brand_Advertiser_Has_CamPaign(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Brand Management Page - Step 01: Search Brand '" + GlobalConstants_KR.BRAND_NAME_HAS_CAMPAIGN_MANAGER_ROLE_KR + "'");
		adminBrandManagementPage.enterToSearchBrandTextBox(GlobalConstants_KR.BRAND_NAME_HAS_CAMPAIGN_MANAGER_ROLE_KR);

		ExtentTestManager.getTest().log(Status.INFO, "Brand Management Page - Step 02: Click on Search Button");
		adminBrandManagementPage.clickToResetButton();

		ExtentTestManager.getTest().log(Status.INFO, "Brand Management Page - Step 03: Search Brand '" + GlobalConstants_KR.BRAND_NAME_HAS_CAMPAIGN_MANAGER_ROLE_KR + "'");
		adminBrandManagementPage.enterToSearchBrandTextBox(GlobalConstants_KR.BRAND_NAME_HAS_CAMPAIGN_MANAGER_ROLE_KR);
		...
		assertEquals(adminBrandManagementPage.getBrandNameByRownNumber("1", "3"), GlobalConstants_KR.BRAND_NAME_HAS_CAMPAIGN_MANAGER_ROLE_KR);
	}
	...
	public void TC_11_Edit_Brand_Information(Method method) {
		...
		adminBrandManagementPage.clickOnByMenuNameLink(driver, GlobalConstants_KR.ADVERTISER_MANAGEMENT_LINK);
		...
		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 05: Input Partner Name '" + GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD + "'");
		adminCreateNewBrandPage.enterToPartNameTextBox(GlobalConstants_KR.PARTNER_NAME_SEARCH_FIELD);

		ExtentTestManager.getTest().log(Status.INFO, "Create Brand Page - Step 06: Select Partner Name '" + GlobalConstants_KR.PARTNER_NAME_AND_EMAIL_SEARCH_FIELD + "'");
		adminCreateNewBrandPage.selectPartnerByName(GlobalConstants_KR.PARTNER_NAME_AND_EMAIL_SEARCH_FIELD);
		...
		assertEquals(adminDetailBrandPage.getSeeBrandTextButton(), GlobalConstants_KR.TITLE_BRAND_MANGEMENT_PAGE);
		...
		adminDetailBrandPage.switchTab(GlobalConstants_KR.ADVERTISER_TEST_URL);
		...
		adminDetailBrandPage.enterToPasswordTextBox(GlobalConstants_KR.PASSWORD);

		ExtentTestManager.getTest().log(Status.INFO, "Brand Management - Step 24: Enter To Confirm Password TextBox");
		adminDetailBrandPage.enterToConfirmPasswordTextBox(GlobalConstants_KR.PASSWORD);
		...
		adminDetailBrandPage.openSelectLanguageList(driver, GlobalConstants_KR.ENGLISH_LANGUAGE);
		...
		adminDetailBrandPage.openSelectLanguageList(driver, GlobalConstants_KR.KOREA_LANGUAGE);
