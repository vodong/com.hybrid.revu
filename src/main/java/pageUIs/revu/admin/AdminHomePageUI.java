...
//	public static final String COUNTRY_DROPDOWN_LIST = "CSS=form.ng-valid ul.mr-20";
	public static final String COUNTRY_LIST = "CSS=div.navbar-collapse div.dropdown a.language-current";
	public static final String COUNTRY_DROPDOWN_LIST = "XPATH=//div[@id='navbar']//ul[@class='dropdown-language']//ul/li[@class='ng-scope']/a[contains(.,'%s')]";
