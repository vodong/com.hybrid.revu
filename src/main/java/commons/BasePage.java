...
public class BasePage {
	...
	public void clickOnByMenuNameLink(WebDriver driver, String pageName) {
		overrideImplicitTimeout(driver, shorTimeOut);
	...
	public PartnerBrandManagementPageObject openBrandManagePartnerByNameLink(WebDriver driver, String pageName) {
	...
	public void openSelectLanguageList(WebDriver driver, String languageName) {
		waitForElementClickable(driver, BasePageUI.LANGUAGE_DROPDOWN_LIST);
		clickToElement(driver, BasePageUI.LANGUAGE_DROPDOWN_LIST);

		waitForElementClickable(driver, BasePageUI.DYNAMIC_LANGUAGE_BY_NAME, languageName);
		clickToElement(driver, BasePageUI.DYNAMIC_LANGUAGE_BY_NAME, languageName);
		sleepInSecond(shorTimeOut);
	}

	public String getTitlePageName(WebDriver driver) {
		waitForElementVisible(driver, BasePageUI.TITLE_PAGE_NAME);
		return getElementText(driver, BasePageUI.TITLE_PAGE_NAME);
	}
